...
var OpenAI = class {
  ...
  async makeRequest(optionsInput, retriesRemaining, retryOfRequestLogID) {
    ...
    await ((_b = (_a3 = this._provider) == null ? void 0 : _a3.prepareRequest) == null ? void 0 : _b.call(_a3, req, { url, options }));
    ...
    if (!response.ok) {
      if (response.status === 401 && this._workloadIdentityAuth && security.bearerAuth && !((_e = options.__metadata) == null ? void 0 : _e["hasStreamingBody"]) && !((_f = options.__metadata) == null ? void 0 : _f["workloadIdentityTokenRefreshed"])) {
